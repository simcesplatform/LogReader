...
def getMessages( simId, epoch  = None, startEpoch = None, endEpoch = None, process = None ):
    '''
    ...
    '''
    log.debug( f'Get messages for simulation {simId} with parameters epoch: {epoch}, startEpoch: {startEpoch}, endEpoch: {endEpoch}, process: {process},.' )
